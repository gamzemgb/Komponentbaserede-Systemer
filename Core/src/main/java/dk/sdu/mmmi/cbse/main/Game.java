   ...
   public Game(List<IEntityProcessingService> entityProcessors,
    ...
    private void draw() {
        for (Entity entity : world.getEntities()) {
            ...
            sr.setColor(entity.getColor()[0], entity.getColor()[1], entity.getColor()[2], 1);

            sr.begin(ShapeRenderer.ShapeType.Line);

            if (entity.getShape() != null && entity.getShape().equals("Ship")) {
                ...
                sr.circle(positionPart.getX(), positionPart.getY(), entity.getRadius());
